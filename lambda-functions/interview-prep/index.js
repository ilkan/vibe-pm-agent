...
exports.handleStartInterviewPreparation = handleStartInterviewPreparation;
exports.handleGenerateInterviewQuestion = handleGenerateInterviewQuestion;
exports.handleEvaluateInterviewResponse = handleEvaluateInterviewResponse;
exports.handleGetInterviewFeedback = handleGetInterviewFeedback;
exports.handleGetCompanyInterviewInsights = handleGetCompanyInterviewInsights;
exports.handleCustomizePreparationForCompany = handleCustomizePreparationForCompany;
...
const handler = async (event, context) => {
    ...
    try {
        ...
        const executionTime = timer.measure();
        logger.error('Interview Prep Lambda error', error, {
            requestId: context.awsRequestId,
            executionTime
        });
...
// Tool Handlers
async function handleStartInterviewPreparation(args) {
...
async function handleGenerateInterviewQuestion(args) {
    ...
    const categoryQuestions = questions[question_category] || questions.behavioral;
...
async function handleEvaluateInterviewResponse(args) {
...
async function handleGetInterviewFeedback(args) {
...
async function handleGetCompanyInterviewInsights(args) {
...
async function handleCustomizePreparationForCompany(args) {
...
// Helper function
function getExpectedFramework(category) {
    switch (category) {
