...
export class AssumptionLedgerService extends BaseService {
    ...
    return this.handleAsync(async () => {
      ...
      const { result } = await performanceMonitor.timeOperation(
        ...
        async () => {
          ...
          const assumptionsWithSources = this.mapCitationsToAssumptions(
            assumptions,
            inputs.citations || []
          );
  ...
  private assignCredibilityRating(hostname: string): 'A' | 'B' | 'C' {
    ...
    const aTierDomains = [
      'mckinsey.com',
      'bcg.com',
      'bain.com', // Top consulting firms
      'gartner.com',
      'forrester.com',
      'idc.com', // Research firms
      'harvard.edu',
      'stanford.edu',
      'mit.edu', // Academic institutions
      'sec.gov',
      'census.gov',
      'bls.gov', // Government sources
      'reuters.com',
      'bloomberg.com',
      'wsj.com', // Financial news
      'statista.com',
      'pwc.com',
      'deloitte.com', // Business intelligence
    ];
   ...
   * Map citations to assumptions based on content relevance
   */
  private mapCitationsToAssumptions(
