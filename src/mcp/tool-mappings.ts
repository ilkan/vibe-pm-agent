...
// Clean tool names without verbose prefix - removed KIRO_PREFIX

/**
 * Mapping of clean tool names to internal tool names
 */
export const KIRO_TOOL_MAPPINGS: Record<string, string> = {
  'analyze_business_opportunity': 'analyze_business_opportunity_enhanced',
  'generate_business_case': 'generate_business_case',
  'create_stakeholder_communication': 'create_stakeholder_communication',
  'assess_strategic_alignment': 'assess_strategic_alignment',
  'validate_market_timing': 'validate_market_timing',
  'optimize_resource_allocation': 'optimize_resource_allocation',
  'generate_requirements': 'generate_requirements',
  'generate_design_options': 'generate_design_options',
  ...
  'generate_roi_analysis': 'generate_roi_analysis',
  'get_consulting_summary': 'get_consulting_summary',
  'validate_idea_quick': 'validate_idea_quick',
  'analyze_competitor_landscape': 'analyze_competitor_landscape',
  'calculate_market_sizing': 'calculate_market_sizing',
};

/**
 * Tool descriptions for clean tool names
 */
export const KIRO_TOOL_DESCRIPTIONS: Record<string, string> = {
  ...
  'analyze_workflow': 'Analyzes workflows for optimization opportunities',
...
export function isKiroTool(toolName: string): boolean {
  return toolName in KIRO_TOOL_MAPPINGS;
}
