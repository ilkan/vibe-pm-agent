...
describe('Amazon Template Snapshots', () => {
      ...
      keyDrivers: [
        {
          ...
          assumptionId: 'A2',
          impact: 15,
          description: 'Market Adoption Rate shows moderate sensitivity (±15% impact on Revenue) - drives market opportunity sizing'
        },
        {
          assumption: 'Developer Productivity Increase',
          assumptionId: 'A1',
          impact: 12,
          description: 'Developer Productivity Increase shows moderate sensitivity (±12% impact on ROI) - drives market opportunity sizing'
        }
      ],
      sensitivityPct: 20
    },
  ...
  describe('PR/FAQ Template Snapshots', () => {
    ...
    it('should render PR/FAQ with maximum data', () => {
      ...
      context.hardQuestions.push(
        {
          id: 4,
          question: 'How will competitors respond to this launch? What if they launch a similar solution first?',
  ...
  describe('Template Edge Cases', () => {
    ...
    it('should handle very long assumption names and values', () => {
      const context = createFixedTemplateContext();
      context.ledger.assumptions[0].name = 'Very Long Assumption Name That Exceeds Normal Length Expectations And Contains Multiple Technical Terms And Detailed Descriptions';
      context.ledger.assumptions[0].value = 'This is an extremely long assumption value that contains detailed explanations, multiple clauses, and comprehensive descriptions that might cause formatting issues in tables and other display elements';
