...
import { ManagementOnePager, PRFAQ, PMRequirements } from '../../components/pm-document-generator';
  ...
  describe('Management One-Pager Format Validation', () => {
    it('should validate one-pager has proper structure', () => {
      const validOnePager: ManagementOnePager = {
        answer:
          'Build the PM Agent Intent Optimizer now to reduce quota costs by 40-60% within Q2 2025.',
        because: [
        ...
        rightTimeRecommendation:
          'Now is the right time because quota costs are escalating quarterly.',
      };
  ...
  describe('PR-FAQ Format Validation', () => {
    it('should validate press release has required structure', () => {
      const validPRFAQ: PRFAQ = {
        pressRelease: {
          ...
          subHeadline:
            'AI-powered system transforms raw developer intent into optimized Kiro specifications',
        ...
        faq: [
          {
            ...
            answer: 'Developers using Kiro who want to optimize quota consumption.',
          },
          {
            question: 'What problem are we solving now?',
            answer: 'Quota overruns that constrain developer productivity.',
          },
          {
            question: 'Why now and why not later?',
            answer: 'Quota costs are escalating quarterly.',
          },
          {
            question: 'What is the smallest lovable version?',
            answer: 'Intent parsing with basic optimization.',
          },
          {
            question: 'How will we measure success?',
            answer: 'Quota reduction percentage and time savings.',
          },
          {
            question: 'What are the top 3 risks and mitigations?',
            answer: 'Complex workflows, ROI accuracy, adoption.',
          },
          {
            question: 'What is not included?',
            answer: 'Advanced workflow debugging and real-time optimization.',
          },
          {
            question: 'How does this compare to alternatives?',
            answer: 'Manual optimization takes hours vs minutes.',
          },
          {
            question: "What's the estimated cost/quota footprint?",
            answer: 'Development cost $300K, 40-60% savings.',
          },
          {
            question: 'What are the next 2 releases after v1?',
            answer: 'Advanced technique library and monitoring.',
          },
        ],
        launchChecklist: [
          {
            task: 'Complete MCP server integration testing',
            owner: 'Engineering',
            dueDate: '2025-05-15',
          },
          ...
          {
            task: 'Conduct beta testing with key customers',
            owner: 'Product',
            dueDate: '2025-05-30',
          },
    ...
    it('should validate FAQ has exactly 10 questions', () => {
      const validPRFAQ: PRFAQ = {
        ...
        launchChecklist: [{ task: 'Task 1', owner: 'Owner 1', dueDate: '2025-05-15' }],
      };
  ...
  describe('Requirements Format Validation', () => {
    it('should validate MoSCoW structure', () => {
      const validRequirements: PMRequirements = {
        businessGoal:
          'Reduce developer quota consumption by 40-60% through intelligent workflow optimization.',
        userNeeds: {
        ...
        constraintsRisks: ['Must integrate seamlessly with existing Kiro workflows'],
        priority: {
          must: [
            {
              requirement: 'Intent parsing and optimization engine',
              justification: 'Core functionality required for any value delivery',
            },
          ],
          should: [
            {
              requirement: 'ROI analysis with multiple scenarios',
              justification: 'Provides decision-making support for optimization choices',
            },
          ],
          could: [
            {
              requirement: 'Advanced workflow debugging',
              justification: 'Nice-to-have for complex optimization scenarios',
            },
          ],
          wont: [
            {
              requirement: 'Real-time workflow monitoring',
              justification: 'Out of scope for MVP, planned for future release',
            },
          ],
        },
        rightTimeVerdict: {
          decision: 'do_now',
          reasoning:
            'Quota costs are escalating quarterly, developer productivity is measurably constrained.',
        },
      };
