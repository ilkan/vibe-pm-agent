...
describe('ConfidenceService', () => {
  ...
  describe('identifyImprovements', () => {
    it('should identify areas for improvement', () => {
      ...
      for (let i = 1; i < improvements.length; i++) {
        expect(improvements[i-1].potentialGain).toBeGreaterThanOrEqual(improvements[i].potentialGain);
      }
  ...
  describe('evidence scoring', () => {
    ...
    it('should give quantity bonus for multiple sources', async () => {
      ...
      expect(multipleResult.data!.breakdown.evidence).toBeGreaterThan(singleResult.data!.breakdown.evidence);
    });
  });
  ...
  describe('recency scoring', () => {
    it('should score recent sources higher than old sources', async () => {
      ...
      expect(recentResult.data!.breakdown.recency).toBeGreaterThan(oldResult.data!.breakdown.recency);
    });
  ...
  describe('diversity scoring', () => {
    it('should score diverse source types higher', async () => {
      ...
      expect(diverseResult.data!.breakdown.diversity).toBeGreaterThan(singleTypeResult.data!.breakdown.diversity);
  ...
  describe('sensitivity scoring', () => {
    it('should score based on sensitivity risk level', async () => {
      ...
      expect(lowRiskResult.data!.breakdown.sensitivity).toBeGreaterThan(highRiskResult.data!.breakdown.sensitivity);
