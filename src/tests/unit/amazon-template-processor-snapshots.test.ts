  ...
  beforeAll(() => {
    ...
    fixedSeedContext = {
      ...
      confidence: {
        ...
        explanation:
          'High-quality evidence with strong source agreement and excellent coverage. Minor concerns around sensitivity to market changes.',
        lowConfidence: false,
      } as ConfidenceScore,
      ...
      hardQuestions: [
        {
          id: 1,
          question:
            'How will the recent economic downturn affect our $1.8B TAM assumption, especially given enterprise budget freezes?',
          targetAssumptions: ['A1', 'A3'],
          category: 'market',
          severity: 'critical',
          evidenceNeeded: [
            'Q4 2023 enterprise spending data',
            'Updated market research',
            'Customer budget surveys',
          ],
        },
        {
          id: 2,
          question:
            'What if competitors like Mixpanel reduce pricing by 30% to defend market share?',
        ...
        },
        {
          id: 3,
          question:
            'Can we realistically achieve 8% churn when industry average is 12% for new products?',
