...
describe('DataAnonymizationService', () => {
  ...
  describe('External API Anonymization', () => {
    ...
    it('should classify data sensitivity', async () => {
      ...
      const result = await service.anonymizeForExternalAPI(
        sensitiveData,
        defaultContext,
        defaultOptions
      );
  ...
  describe('Reversible Anonymization', () => {
    ...
    it('should reverse anonymization correctly', async () => {
      ...
      const anonymized = await service.createReversibleAnonymization(
        originalData,
        sessionId,
        defaultOptions
      );
    ...
    it('should handle expired reversibility maps', async () => {
      ...
      await expect(service.reverseAnonymization(data, sessionId)).rejects.toThrow(
        'Reversibility map not found or expired'
      );
    });
  });
  ...
  describe('Error Handling', () => {
    it('should handle malformed data gracefully', async () => {
      ...
      await expect(
        service.anonymizeForExternalAPI(malformedData, defaultContext, defaultOptions)
