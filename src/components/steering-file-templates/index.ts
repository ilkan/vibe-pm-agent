...
*Feature: {feature_name} | Document Type: Implementation Plan*`,
    ...
    this.templates.set(DocumentType.COMPETITIVE_ANALYSIS, {
      documentType: DocumentType.COMPETITIVE_ANALYSIS,
      defaultInclusionRule: 'fileMatch',
      defaultFileMatchPattern: 'competitive*|competitor*|market*|analysis*',
      template: `# Competitive Analysis Guidance: {feature_name}

This guidance contains competitive intelligence and strategic positioning insights from PM Agent analysis.
...
When building this feature, consider the competitive context:

- Differentiate from existing solutions in the market
- Focus on identified market gaps and opportunities
- Leverage competitive advantages in implementation
- Monitor competitor moves and adjust strategy accordingly
- Validate positioning assumptions with market feedback

## Competitive Monitoring

Key areas to track:
- Competitor feature releases and updates
- Market share changes and customer feedback
...
- [ ] Competitive differentiation is clear and validated
- [ ] Market positioning aligns with business strategy
- [ ] Competitive advantages are leveraged in implementation
- [ ] Market gaps are addressed effectively
- [ ] Competitive risks are identified and mitigated

---
*Generated by PM Agent Competitive Analysis on {timestamp}*
*Feature: {feature_name} | Document Type: Competitive Analysis*`,
      requiredPlaceholders: [
        'feature_name',
        'timestamp',
        'competitive_landscape',
      ...
      validateContent: (content: string) => {
        return content.includes('Competitive') && content.includes('Analysis');
      }
    });

    // Market Sizing template
    this.templates.set(DocumentType.MARKET_SIZING, {
      documentType: DocumentType.MARKET_SIZING,
      defaultInclusionRule: 'fileMatch',
      defaultFileMatchPattern: 'market*|sizing*|tam*|sam*|som*|opportunity*',
      template: `# Market Sizing Guidance: {feature_name}

This guidance contains market opportunity analysis and TAM/SAM/SOM insights from PM Agent analysis.
...
When developing this feature, consider the market context:

- Size the opportunity to guide investment decisions
- Validate market assumptions through customer research
- Use market data to inform pricing and positioning
- Monitor market dynamics and adjust strategy accordingly
- Leverage market insights for go-to-market planning

## Market Validation Framework

Key validation activities:
- Customer interviews to validate market assumptions
- Competitive analysis to refine market positioning
- Pilot programs to test market response
- Market research to validate sizing estimates
- Financial modeling to assess opportunity value
...
- [ ] Market size estimates are validated with multiple sources
- [ ] Market assumptions are tested with customer feedback
- [ ] Competitive landscape is thoroughly understood
- [ ] Market entry strategy is defined and validated
- [ ] Financial projections align with market opportunity

## Success Metrics

Track these metrics to validate market assumptions:
- Market penetration rate vs. projections
- Customer acquisition cost vs. market size
- Revenue per customer vs. market value estimates
- Market share growth vs. competitive positioning
- Customer feedback vs. market positioning assumptions

---
*Generated by PM Agent Market Sizing Analysis on {timestamp}*
*Feature: {feature_name} | Document Type: Market Sizing*`,
      requiredPlaceholders: [
        'feature_name',
        'timestamp',
        'market_opportunity',
      ...
      validateContent: (content: string) => {
        return content.includes('Market') && (content.includes('TAM') || content.includes('Sizing'));
      }
    });
  }
